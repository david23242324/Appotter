...
const Original = () => {
  ...
  const houses = [
    ...
    },
    {
      ...
      description: "Eres leal, trabajador y siempre estás para los demás. La casa más noble de Hogwarts.",
    },
    {
      name: "Ravenclaw",
  ...
  return (
    <div className="min-h-screen bg-gray-950 px-4 pt-6 pb-20 flex flex-col">
        ...
        <div className="flex flex-col items-center justify-center flex-1 gap-8">
          ...
          <div className="grid grid-cols-2 gap-3 w-full">
            {houses.map((house) => (
              <div
                key={house.name}
                className={`rounded-xl border ${house.border} bg-gray-900 p-3`}
              >
        ...
        <div className="flex flex-col items-center justify-center flex-1 gap-6">
          ...
          <div className="flex gap-4">
            {houses.map((house, i) => (
              <div
                key={house.name}
                className={`w-8 h-8 rounded-full animate-pulse ${house.bg}`}
      ...
      {phase === "result" && selectedHouse && (
        <div className="flex flex-col items-center justify-center flex-1 gap-6">
          <div className={`w-full rounded-2xl border-2 ${selectedHouse.border} ${selectedHouse.bg} p-6 text-center`}>
