const Info = () => {
  ...
  const facts = [
    { emoji: "📚", text: "La saga tiene 7 libros escritos por J.K. Rowling" },
    { emoji: "🎬", text: "8 películas producidas entre 2001 y 2011" },
    { emoji: "🧙", text: "Más de 700 personajes en todo el universo" },
    { emoji: "🏰", text: "Hogwarts fue fundada hace más de 1000 años" },
    { emoji: "⚡", text: "Harry Potter nació el 31 de julio de 1980" },
    { emoji: "🪄", text: "Existen 3 tipos de varitas: madera, núcleo y largo" },
  ];
